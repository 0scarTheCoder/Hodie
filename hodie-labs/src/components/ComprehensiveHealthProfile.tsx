    ...
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="text-center">
          ...
          <p className="text-white/70">Analysing genetic data, lab results, and generating personalised insights...</p>
        </div>
      </div>
    );
  }
          ...
          <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 rounded-xl p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="text-center">
                ...
                <div className="text-white/70 text-sm">Genetic Variants Analysed</div>
              ...
              <div className="text-center">
                ...
                <div className="text-white/70 text-sm">Lab Panels Analysed</div>
                <div className="text-xs text-white/60 mt-1">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-r from-orange-600/20 to-red-600/20 rounded-xl p-6">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <h3 className="text-xl font-semibold text-white">Personalised AI Recommendations</h3>
            </div>
