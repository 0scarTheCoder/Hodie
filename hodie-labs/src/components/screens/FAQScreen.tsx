...
const FAQScreen: React.FC<FAQScreenProps> = ({ user }) => {
  ...
  const faqData: FAQItem[] = [
    ...
    },
    {
      ...
      answer: 'Getting started is simple: 1) Complete your comprehensive health profile, 2) Upload your existing blood test results or book new tests, 3) Optionally take our DNA test, 4) Receive personalised recommendations and insights through your dashboard.',
      icon: Activity
    },
    {
      id: '3',
    ...
    // Blood Tests
    {
      ...
      question: 'What blood markers do you analyse?',
      answer: 'We analyse over 50 biomarkers including lipid profiles, inflammation markers (CRP, ESR), metabolic markers (glucose, HbA1c), hormone levels, nutrient status (vitamins, minerals), liver function, kidney function, and cancer markers like PSA.',
      icon: Stethoscope
    },
    {
      id: '5',
      ...
      answer: 'Yes! You can upload blood test results from any accredited labouratory. Our AI system will analyse the results and integrate them into your health profile. We accept PDF reports, images, or you can manually enter the values.',
      icon: Stethoscope
    },
    {
      id: '6',
    ...
    },
    {
      ...
      answer: 'Our DNA testing uses clinical-grade sequencing with >99.9% accuracy. We analyse proven genetic variants with strong scientific evidence. Results are interpreted by geneticists and include confidence levels for each finding.',
      icon: Dna
    },
    ...
    },
    {
      ...
      answer: 'You can book scans directly through your dashboard. We have partnerships with imaging centres across Australia. Simply select your preferred location and time slot, and we\'ll handle the rest.',
      icon: Camera
    },
    ...
    // Health Insights
    {
      ...
      answer: 'Recommendations are generated using AI algorithms that analyse your genetic profile, biomarker results, lifestyle data, and health goals. They\'re reviewed by our medical team and updated as new data becomes available.',
      icon: Activity
    },
    {
      id: '12',
